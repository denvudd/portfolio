...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[250vh] pt-40 overflow-hidden relative flex flex-col self-auto"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full">
      <h1 className="text-4xl md:text-7xl font-bold dark:text-white">
        Dmytro Yurin <br /> front-end developer
      </h1>
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 font-semibold group-hover/product:opacity-100 text-white">
        {product.title}
      </h2>
    </motion.div>
  );
