...
export const LampContainer = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn(
        "relative flex h-[50rem] flex-col items-center justify-center overflow-hidden w-full rounded-md z-0 bg-bacgkround",
        className
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5">
        <motion.h1
          ...
          className="bg-gradient-to-br from-slate-300 to-slate-500 bg-clip-text text-center leading-[1.4] font-medium tracking-tight text-transparent text-3xl md:text-6xl"
        >
          I can build the application <br /> of your dream
        </motion.h1>
      </div>
    </div>
  );
